...
namespace Orchard.Tests.Modules.Widgets
{
    ...
    public class WidgetFilterTests
    {
        ...
        public void Init()
        {
            ...
            var contentDisplay = new Mock<IContentDisplay>();

            builder.RegisterInstance(contentQuery.Object).As<IContentQuery>();
            ...
            contentQuery.Setup(cq => cq.ForPart<ContentItem>()).Returns(contentQuery.Object);
            ...
            var contentManager = new DefaultContentManager(_container, null, null, null, null, null, null, new Lazy<IContentDisplay>(() => contentDisplay.Object), null, null, null, null, null, null);

            orchardService.Setup(o => o.ContentManager).Returns(contentManager);
            builder.RegisterInstance(contentManager).As<IContentManager>();
