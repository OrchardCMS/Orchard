...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Setup", "    In order to install orchard\r\n    As a new user\r\n    I want to access the Setu" +
                    "p screen from the default screen and the Setup folder, then the Setup should be " +
                    "successful if required fields are filled in", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("RootAndSetupFolderShowsSetupScreenAndFormValuesAreValidated", null, ((string[])(null)));
#line 6
...
#line hidden
            ...
            table196.AddRow(new string[] {
                        ...
                        "6655321"});
#line 26
        testRunner.And("I fill in", ((string)(null)), table196, "And ");
#line 31
        testRunner.And("I hit \"Finish Setup\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 32
