namespace Orchard.Security {
    ...
    public class CreateUserParams {
        ...
        public CreateUserParams(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, string contentType = null) {
            _username = username;
            _password = password;
            _email = email;
