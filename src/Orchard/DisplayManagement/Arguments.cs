    ...
    public static class Arguments
    {
        ...
        class NamedEnumerable<T> : INamedEnumerable<T>
        {
            ...
            class Named : IDictionary<string, T>
            {
                ...
                ICollection<string> IDictionary<string, T>.Keys => _namesCollection = _namesCollection ?? _names as ICollection<string> ?? _names.ToArray();

                ICollection<T> IDictionary<string, T>.Values => _argumentsCollection = _argumentsCollection ?? _arguments as ICollection<T> ?? _arguments.ToArray();
            }
        }
