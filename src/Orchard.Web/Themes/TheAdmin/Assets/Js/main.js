/*!
 * orchard-admin v1.2.0 (http://www.orchardproject.net/)
 * Copyright 2014-2016 Miguel Henao 
 */
var App = (function () {
    'use strict';
        ...
        if (openLeftSidebarOnClick) {
            ...
            firstAnchor.on('mouseleave', function () {
                ...
                if (!$.isXs()) {
                    ...
                    setTimeout(function () {
                        // http://stackoverflow.com/a/8981521/156388
                        if (subMenu.filter(function () { return $(this).is(":hover"); }).length > 0) {
