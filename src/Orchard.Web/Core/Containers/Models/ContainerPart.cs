...
namespace Orchard.Core.Containers.Models
{
    public class ContainerPart : ContentPart<ContainerPartRecord>
    {
        ...
        public ContainerTypePartSettings ContainerSettings => ContainerSettingsField.Value;

        public bool EnablePositioning => ContainerSettings.EnablePositioning != null ? ContainerSettings.EnablePositioning.Value : Record.EnablePositioning;

        public IListViewProvider AdminListView => AdminListViewField.Value;
