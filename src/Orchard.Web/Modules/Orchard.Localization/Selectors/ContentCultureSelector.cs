    ...
    public class ContentCultureSelector : ICultureSelector {
        ...
        public CultureSelectorResult GetCulture(HttpContextBase context) {
            ...
            if (!string.IsNullOrEmpty(_shellSettings.RequestUrlPrefix) && 
                    requestUrl.StartsWith(_shellSettings.RequestUrlPrefix, StringComparison.OrdinalIgnoreCase)) {
                requestUrl = requestUrl.Substring(_shellSettings.RequestUrlPrefix.Length).TrimStart('/');
            }
