...
namespace Orchard.Tokens.Implementation
{
    public class TokenManager : ITokenManager
    {
        ...
        private class EvaluateContextImpl : EvaluateContext
        {
            ...
            public override string Target => _target;

            public override IDictionary<string, string> Tokens => _tokens;

            public override IDictionary<string, object> Data => _data;

            public override IDictionary<string, object> Values => _values;
            ...
            {
                public override TData Data => default(TData);
        ...
        private class DescribeForImpl : DescribeFor
        {
            ...
            public override IEnumerable<TokenDescriptor> Tokens => _tokens;
