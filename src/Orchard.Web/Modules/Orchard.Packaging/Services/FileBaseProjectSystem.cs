...
namespace Orchard.Packaging.Services
{
    public class FileBasedProjectSystem : IProjectSystem
    {
        ...
        public virtual FrameworkName TargetFramework => _targetFramework ?? (_targetFramework = new FrameworkName(NetFrameworkIdentifier, typeof(string).Assembly.GetNameSafe().Version));
