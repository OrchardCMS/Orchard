...
namespace Orchard.Workflows.Activities
{
    public class LoggingActivity : Task
    {
        ...
        public override LocalizedString Category => T("Diagnostics");

        public override LocalizedString Description => T("Creates an entry in the application's logs.");

        public override string Form => "ActivityLog";
