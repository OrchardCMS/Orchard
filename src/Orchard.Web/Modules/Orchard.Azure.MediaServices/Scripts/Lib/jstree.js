...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        _append_json_data: function (dom, data) {
            ...
            dom.children = [];
            dom.children_d = [];
            var dat = data, par = dom.id, chd = [], dpc = [], m = this._model.data, p = m[par], s = this._data.core.selected.length, tmp, i, j;
            // *%$@!!!
            if (dat.d) {
                dat = dat.d;
        ...
        _parse_model_from_flat_json: function (d, p, ps) {
            ...
            var tid = d.id, m = this._model.data, df = this._model.default_state, i, j, c, e, tmp = {
                id: tid,
                text: d.text || '',
        ...
        redraw_node: function (node, deep, is_callback) {
            var obj = this.get_node(node), par = false, ind = false, old = false, i = false, j = false, k = false, c = '', d = document, m = this._model.data, f = false, s = false;
            if (!obj) {
                return false;
            }
            if (obj.id === '#') {
        ...
        open_all: function (obj, animation, original_obj) {
            ...
            dom.each(function () {
                _this.open_node(this, function (node, status) { if (status && this.is_parent(node)) {
        ...
        edit: function (obj, default_text) {
            ...
            */
            t = typeof default_text === 'string' ? default_text : this.get_text(obj), h1 = $("<" + "div />", { css: { "position": "absolute", "top": "-200px", "left": (rtl ? "0px" : "-1000px"), "visibility": "hidden" } }).appendTo("body"), h2 = $("<" + "input />", {
                "value": t,
         ...
         * @name toggle_stripes()
         */
        toggle_stripes: function () { if (this._data.core.themes.stripes) {
            this.hide_stripes();
        }
        else {
            this.show_stripes();
         ...
         * @name toggle_dots()
         */
        toggle_dots: function () { if (this._data.core.themes.dots) {
            this.hide_dots();
        }
        else {
            this.show_dots();
    ...
    // browser sniffing
    (function () {
        var browser = {}, b_match = function (ua) {
            ua = ua.toLowerCase();
    ...
    $.jstree.plugins.checkbox = function (options, parent) {
        this.bind = function () {
            ...
            if (this.settings.checkbox.three_state) {
                this.element
                    ...
                    var obj = data.node, m = this._model.data, par = this.get_node(obj.parent), dom = this.get_node(obj, true), i, j, c, tmp;
                    ...
                    var obj = data.node, dom = this.get_node(obj, true), i, j, tmp;
                    for (i = 0, j = obj.children_d.length; i < j; i++) {
         ...
         * @plugin checkbox
         */
        this.toggle_checkboxes = function () { if (this._data.core.themes.checkboxes) {
    ...
    $(function () {
        ...
        $(document)
            ...
            var ins = $.jstree.reference(data.event.target), ref = false, off = false, rel = false, l, t, h, p, i, o, ok, t1, t2, op, ps, pr;
    ...
    (function ($) {
        ...
        $.vakata.dnd = {
            ...
            drag: function (e) {
                ...
                if (!vakata_dnd.is_drag) {
                    if (Math.abs(e.pageX - vakata_dnd.init_x) > $.vakata.dnd.settings.threshold ||
    ...
    $.jstree.plugins.search = function (options, parent) {
        ...
        this.search = function (str, skip_async) {
            ...
            var s = this.settings.search, a = s.ajax ? $.extend({}, s.ajax) : false, f = null, r = [], p = [], i, j;
        ...
        this._search_load = function (str) {
            var res = true, t = this, m = t._model.data;
                ...
                if (!this._data.search.sln.length) {
                    ...
                    $.each(this._data.search.sln, function (i, v) {
                        if (m[v]) {
                            ...
                            if (!m[v].state.loaded) {
                                t.load_node(v, function (o, s) { if (s) {
                                    t._search_load(str);
                                } });
                                res = false;
                            }
    ...
    $.jstree.plugins.unique = function (options, parent) {
        this.check = function (chk, obj, par, pos) {
            ...
            var n = chk === "rename_node" ? pos : obj.text, c = [], m = this._model.data, i, j;
            for (i = 0, j = par.children.length; i < j; i++) {
