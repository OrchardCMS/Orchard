...
namespace Orchard.DynamicForms.Recipes.Builders
{
    public class FormSubmissionsStep : RecipeBuilderStep
    {
        ...
        public override string Name => "FormSubmissions";

        public override LocalizedString DisplayName => T("Form Submissions");

        public override LocalizedString Description => T("Exports submitted forms.");
