...
namespace Orchard.Comments.Activities
{
    ...
    public class CloseCommentsActivity : Task
    {
        ...
        public override string Name => "CloseComments";

        public override LocalizedString Category => T("Comments");

        public override LocalizedString Description => T("Closes the comments on the currently processed content item.");
