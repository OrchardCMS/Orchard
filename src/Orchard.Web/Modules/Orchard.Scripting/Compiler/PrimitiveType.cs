...
namespace Orchard.Scripting.Compiler
{
    ...
    public class BooleanPrimitiveType : PrimitiveType
    {
        ...
        public static BooleanPrimitiveType Instance => _instance ?? (_instance = new BooleanPrimitiveType());
    ...
    public class IntegerPrimitiveType : PrimitiveType
    {
        ...
        public static IntegerPrimitiveType Instance => _instance ?? (_instance = new IntegerPrimitiveType());
    ...
    public class StringPrimitiveType : PrimitiveType
    {
        ...
        public static StringPrimitiveType Instance => _instance ?? (_instance = new StringPrimitiveType());
    ...
    public class NullPrimitiveType : PrimitiveType
    {
        ...
        public static NullPrimitiveType Instance => _instance ?? (_instance = new NullPrimitiveType());
    ...
    public class ErrorPrimitiveType : PrimitiveType
    {
        ...
        public static ErrorPrimitiveType Instance => _instance ?? (_instance = new ErrorPrimitiveType());
