...
namespace Orchard.Taxonomies.Drivers
{
    public class TermPartDriver : ContentPartDriver<TermPart>
    {
        ...
        protected override string Prefix => "Term";
        ...
        protected override void Exporting(TermPart part, ExportContentContext context)
        {
            ...
            foreach (var pathPart in part.Path.Split('/'))
            {
                ...
                var parent = _contentManager.Get(int.Parse(pathPart));
        ...
        protected override void Importing(TermPart part, ImportContentContext context)
        {
            ...
            part.Count = int.Parse(context.Attribute(part.PartDefinition.Name, "Count"));
            part.Selectable = bool.Parse(context.Attribute(part.PartDefinition.Name, "Selectable"));
            part.Weight = int.Parse(context.Attribute(part.PartDefinition.Name, "Weight"));
