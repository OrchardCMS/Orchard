...
namespace Orchard.Roles.Activities
{
    ...
    public class UnssignRoleActivity : Task
    {
        ...
        public override string Name => "UnassignRole";

        public override LocalizedString Category => T("User");

        public override LocalizedString Description => T("Unassign specific roles from the current content item if it's a user.");
