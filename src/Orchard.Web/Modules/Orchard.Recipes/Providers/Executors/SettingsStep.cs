...
namespace Orchard.Recipes.Providers.Executors
{
    public class SettingsStep : RecipeExecutionStep
    {
        ...
        private IEnumerable<IContentHandler> Handlers => _handlers.Value;
        ...
        */
        ...
        private void ImportSettingPart(ContentPart sitePart, XElement element)
        {
            ...
            foreach (var attribute in element.Attributes())
            {
                ...
                {
                    property.SetValue(sitePart, bool.Parse(attributeValue), null);
                }
                else if (propertyType == typeof(int))
                {
                    property.SetValue(sitePart, int.Parse(attributeValue), null);
                }
            }
        }
    }
