...
namespace Orchard.Recipes.Providers.Executors
{
    public class RemoveContentDefinitionStep : RecipeExecutionStep
    {
        ...
        public override string Name => "RemoveContentDefinition";

        public override LocalizedString DisplayName => T("Remove Content Definition");

        public override LocalizedString Description => T("Removes a list of content definitions.");
