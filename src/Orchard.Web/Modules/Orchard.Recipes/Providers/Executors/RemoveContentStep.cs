...
namespace Orchard.Recipes.Providers.Executors
{
    public class RemoveContentStep : RecipeExecutionStep
    {
        ...
        public override string Name => "RemoveContent";

        public override LocalizedString DisplayName => T("Remove Content");

        public override LocalizedString Description => T("Removes a list of content items.");
