...
namespace Orchard.Recipes.Providers.Executors
{
    public class ContentStep : RecipeExecutionStep
    {
        ...
        public override IEnumerable<string> Names => new[] { Name, "Data" };

        public override LocalizedString DisplayName => T("Content");

        public override LocalizedString Description => T("Provides additional configuration for the Content recipe step.");
