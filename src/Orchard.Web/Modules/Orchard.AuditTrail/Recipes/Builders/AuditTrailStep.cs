...
namespace Orchard.AuditTrail.Recipes.Builders
{
    ...
    public class AuditTrailStep : RecipeBuilderStep
    {
        ...
        public override string Name => "AuditTrail";

        public override LocalizedString DisplayName => T("AuditTrail");

        public override LocalizedString Description => T("Exports audit trail events.");
