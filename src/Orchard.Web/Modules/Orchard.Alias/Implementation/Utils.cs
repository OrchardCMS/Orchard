...
namespace Orchard.Alias.Implementation
{
    public static class Utils
    {
        ...
        public class LookupHttpContext : HttpContextBaseWrapper
        {
            ...
            public override HttpRequestBase Request => new LookupHttpRequest(this, base.Request, _path);
            ...
            private class LookupHttpRequest : HttpRequestBaseWrapper
            {
                ...
                public override Uri Url => new Uri(Path, UriKind.Relative);

                public override Uri UrlReferrer => null;

                public override string CurrentExecutionFilePath => Path;
